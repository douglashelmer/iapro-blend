  ...
  return (
    <section className="sec" id="preco">
      <div className="price-wrap reveal" ref={wrapRef}>
        <div className="price-tag">75% OFF — Oferta especial</div>
        <p className="price-de">De R$ 997</p>
        <div className="price-main">12x <sup>R$</sup>39<span style={{ fontSize: '50%' }}>,72</span></div>
        <p className="price-or">ou à vista por</p>
        <div className="price-pix">R$ 397 no PIX</div>
        <ul className="price-list">
          {ITEMS.map(i => <li key={i}>{i}</li>)}
        </ul>
        <a href={CTA} className="btn-cta-big">Garantir meu acesso agora</a>
        <p className="price-secure">🔒 Pagamento 100% seguro · Garantia de 7 dias</p>
      </div>
    </section>
  )
}
